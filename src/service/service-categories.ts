...
const getCategories = async () => {
  const response = await HttpClient.get<Response<ICategories[]>>(
    api.categories.get,
  );
  return response;
};
...
const createCategory = async (data: ICategoriesCreate) => {
  const response = await HttpClient.post<Response<ICategoriesCreate>>(
...
const deleteCategory = async (id: number) => {
  const response = await HttpClient.delete<Response<ICategories>>(
...
const updateCategory = async ({
  ...
  const response = await HttpClient.patch<Response<ICategoriesCreate>>(
