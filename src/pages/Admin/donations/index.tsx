...
import { useDonations, useUpdateDonation } from '@rsces/service/service-donation';
...
const pendingDonations = donationData?.filter((donation) => donation.isAccepted === false);
const completedDonations = donationData?.filter((donation) => donation.isAccepted === true);
function onSubmit() {
  const data = {"isAccepted": true}
  console.log(confirmationId);
  confirmationId &&
  acceptDonation({data ,id: confirmationId});
  }
...
<ConfirmationModel
        ...
        confirmationMessage='Are you sure you want to complete this donation?'
